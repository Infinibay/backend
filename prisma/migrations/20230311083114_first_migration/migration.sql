-- AlterTable
ALTER TABLE "VirtualMachine" ADD COLUMN     "diskId" TEXT;
...
-- AddForeignKey
ALTER TABLE "VirtualMachine" ADD CONSTRAINT "VirtualMachine_diskId_fkey" FOREIGN KEY ("diskId") REFERENCES "Disk"("id") ON DELETE SET NULL ON UPDATE CASCADE;
