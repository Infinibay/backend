...
describe('VMHealthQueueManager', () => {
    ...
    beforeEach(() => {
        ...
        queueManager = new VMHealthQueueManager_1.VMHealthQueueManager(jest_setup_1.mockPrisma, mockEventManager);
        jest.clearAllMocks();
    ...
    describe('queueHealthCheck', () => {
        it('should queue a single health check successfully', () => __awaiter(void 0, void 0, void 0, function* () {
            jest_setup_1.mockPrisma.vMHealthCheckQueue.create.mockResolvedValue({
                id: 'test-queue-id',
            ...
            const queueId = yield queueManager.queueHealthCheck(mockMachineId, 'DISK_SPACE', 'MEDIUM', { test: 'data' });
            ...
            expect(jest_setup_1.mockPrisma.vMHealthCheckQueue.create).toHaveBeenCalled();
        ...
        it('should successfully queue health check when VM is running', () => __awaiter(void 0, void 0, void 0, function* () {
            jest_setup_1.mockPrisma.machine.findUnique.mockResolvedValue(createMockVM(machine_status_1.RUNNING_STATUS));
            jest_setup_1.mockPrisma.vMHealthCheckQueue.create.mockResolvedValue({
                id: 'test-queue-id',
                machineId: mockMachineId,
                checkType: 'DISK_SPACE',
            ...
            const queueId = yield queueManager.queueHealthCheck(mockMachineId, 'DISK_SPACE');
    ...
    describe('queueHealthChecks', () => {
        it('should queue all standard health checks for a VM', () => __awaiter(void 0, void 0, void 0, function* () {
            jest_setup_1.mockPrisma.vMHealthCheckQueue.create.mockResolvedValue({
                id: 'test-queue-id',
                machineId: mockMachineId,
            ...
            jest_setup_1.mockPrisma.vMHealthSnapshot.create.mockResolvedValue({
                id: 'snapshot-1',
                machineId: mockMachineId,
        ...
        it('should throw error when VM not found', () => __awaiter(void 0, void 0, void 0, function* () {
            jest_setup_1.mockPrisma.machine.findUnique.mockResolvedValue(null);
            yield expect(queueManager.queueHealthChecks(mockMachineId)).rejects.toThrow(`VM with ID ${mockMachineId} not found`);
        }));
        it('should successfully queue all health checks when VM is running', () => __awaiter(void 0, void 0, void 0, function* () {
            jest_setup_1.mockPrisma.machine.findUnique.mockResolvedValue(createMockVM(machine_status_1.RUNNING_STATUS));
            jest_setup_1.mockPrisma.vMHealthCheckQueue.create.mockResolvedValue({
                id: 'test-queue-id',
                machineId: mockMachineId,
    ...
    describe('processQueue', () => {
        it('should process queued health checks when called', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            jest_setup_1.mockPrisma.vMHealthCheckQueue.findMany.mockResolvedValue([
                {
                    id: 'test-id',
                    machineId: mockMachineId,
                    checkType: 'DISK_SPACE',
            ...
            yield queueManager.processQueue(mockMachineId);
            // Verify that pending tasks were loaded from database
            expect(jest_setup_1.mockPrisma.vMHealthCheckQueue.findMany).toHaveBeenCalledWith({
                where: {
                    machineId: mockMachineId,
        ...
        it('should return early when queue is empty', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock empty queue
            jest_setup_1.mockPrisma.vMHealthCheckQueue.findMany.mockResolvedValue([]);
            yield queueManager.processQueue(mockMachineId);
            // Should not attempt any processing for empty queue
            expect(jest_setup_1.mockPrisma.vMHealthCheckQueue.update).not.toHaveBeenCalled();
        }));
    });
    describe('clearQueue', () => {
        it('should clear queue for a VM', () => __awaiter(void 0, void 0, void 0, function* () {
            jest_setup_1.mockPrisma.vMHealthCheckQueue.deleteMany.mockResolvedValue({ count: 2 });
            yield queueManager.clearQueue(mockMachineId);
            expect(jest_setup_1.mockPrisma.vMHealthCheckQueue.deleteMany).toHaveBeenCalledWith({
                where: {
                    machineId: mockMachineId,
                    status: {
